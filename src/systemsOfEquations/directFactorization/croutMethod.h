...
#include <vector>
/**
 * Solves a system of N equations by using Crout's LU Factorization
 ...
 */
void __LUFactorization(std::vector<std::vector<double>> &A, std::vector<std::vector<double>> &L, std::vector<std::vector<double>> &U,  int N);
